...
if __name__ == '__main__':
    ...
    img_name = "./data/Final_Publication_2013_SBSDI_sourcecode_withpcode/test.tif"  # 图像的路径
    ...
    cv2.imwrite("./img/BM3D_step_one.png", Basic_img)
    ...
    cv2.imwrite("./img/BM3D_step_two.png", Final_img)
