...
| DUKE28 | psnr | ssim | gcmse |
| -- | -- | -- | -- |
| noise | 17.737815976142883 | 0.21825392738576707 | 80.06362586525003 |
| noise_article | 17.941±0.454 | 0.102±0.029 | 68.078±25.831 |
| mine | 25.784355137083267 | 0.7383120822841461 | 29.82483338627205 |
| article | 28.052±1.807 | 0.704±0.046 | 18.082±17.713 |

1. ssim 明显不同应该是计算方式不同导致的，我直接拿 skimage 算的
2. DUKE28 的数据我使用的可能有些问题（我没找到28相关的图像文件夹，用的`For synthetic experiments`）
